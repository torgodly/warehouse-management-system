...
<body class="bg-gray-300">
    <main class="h-screen">
        ...
        <div class=" flex flex-col justify-center items-center space-x-5">
            ...
            <h1 class="text-2xl font-bold">قسم التصدير</h1>
            <div class=" bg-white p-5 rounded-xl mt-10 ">
                <form action="/export" method="post">
                    @csrf
                    <div>
                        <label for="name">اسم المنتج</label>
                        <input type="text" placeholder="book" name="product_name" value="{{ old('name') }}"
                    ...
                    <div class="mt-3">
                        ...
                        <select name="section" placeholder=""
                            class="mt-1 pl-5 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="quantity" placeholder="10"
                            class="mt-1 pl-5 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                        @error('quantity')
                            <p class="text-red-600 mt-1 ml-2">{{ $message }}</p>
                        @enderror
